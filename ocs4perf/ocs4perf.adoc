...
.Example output:
----
jcl-sysbench-idle-rwx.yaml
jcl-sysbench-idle.yaml
jcl-sysbench-read-rwx.yaml
jcl-sysbench-readwrite-rwx.yaml
jcl-sysbench-readwrite.yaml
jcl-sysbench-read.yaml
jcl-sysbench-write-rwx.yaml
jcl-sysbench-write.yaml
----
