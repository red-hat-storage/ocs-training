...
Click the green `Start Lab` button at the top right to start your lab. You will see login information for your environment in a box on the left of your window.

image::images/lab_creds.jpg[]

Take note of your *SSHUserName* (always `cloud-user`), *SSHPassword* and *Public Master Host URL*. It may be a good idea to save them into a text file on your computer.

*Disregard the Lab Guide link presented to you above SSHUserName and continue using this Lab Guide instead.*

The complete provisioned environment consists of the following systems:
...
Use the *username* `cloud-user` and the *password* provided to you on the Lab home page to login using the SSH client on your local machine.
...
[TIP]
If you don't have an SSH client on your machine you can use a web-based SSH console if needed using the same credentials . Consult the *Lab home page* for the actual URL of the SSH Console.
