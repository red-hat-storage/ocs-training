...
== Review Registry Operator configuration settings
...
Close the `VI` editor by pressing kbd:[ESC] and then kbd:[:] followed by kbd:[q]kbd:[!] and kbd:[ENTER] or simply useL kbd:[Shift + ZZ]
...
Then check the cluster operator status
