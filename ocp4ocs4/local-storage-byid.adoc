...
Once inside the toolbox, try out the following Ceph commands to see the status of Ceph, the total number of OSDs (should be six after expanding storage), and the total amount of storage available in the cluster.
