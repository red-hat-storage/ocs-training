...
image::imgs/ceph101-cephfs.png[Kernel Based CephFS Client,align="center"]

.Object Storage (S3 and Swift Support)
...
=== Pools and PGs
image::imgs/ceph101-thefullpicture.png[From Object to OSD,align="center"]

=== Data Protection
Ceph supports two types of data protection presented in the diagram below.

.Ceph Data Protection
image::imgs/ceph101-dataprotection.png[Replicated Pools vs Erasure Coded Pools,align="center"]
