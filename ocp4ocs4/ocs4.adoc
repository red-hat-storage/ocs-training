...
Then let's try a more relevant query example and enter the following text (`rate(ceph_osd_op[5m)`)in the query field. When you are done typing, simply hit kbd:[Enter]
...
image::imgs/metrics-ocpshboard.png[Grafana Dashboard]
