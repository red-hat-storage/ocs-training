...
while Erasure Coding provide a cost efficient way to store data. We support the following Erasure Coding profiles with the Ceph cluster:
...
Out of the box, each access method uses an object size of 4MB. The above diagram details how a 32MB RBD (Block Device) supporting a RWO PVC will
