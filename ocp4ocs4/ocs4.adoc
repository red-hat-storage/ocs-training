...
In this section, you will validate the OCP environment has 3 master and 2 (or 3 worker nodes) before increasing the cluster size by 3 worker nodes. The `NAME` of your OCP nodes will be different than shown below.
