...
[NOTE]
====
For more information on the Prometheus query language visit link:https://prometheus.io/docs/prometheus/latest/querying/basics/[Prometheus Query Documentation].
====
