...
You can also watch the deployment also using the Openshift Web Console by going back to the `Openshift Container Storage Operator` screen and selecting `All instances`.
