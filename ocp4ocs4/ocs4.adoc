...
image::imgs/ceph101-cephs.png[Kernel Based CephFS Client]
...
image::imgs/ceph101-thefullpicture.png[From Object to OSD Detailed]
...
image::imgs/ceph101-dataprotection.png[Repliacted Pools vs Erasure Coded Pools]
