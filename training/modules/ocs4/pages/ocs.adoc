...
[source,role="execute"]
----
curl -s https://raw.githubusercontent.com/mid998/ocs-training/master/training/modules/ocs4/attachments/photo-album.tar.gz | tar xvz 
----
...
Then, run the application startup script which will build and deploy the app to your cluster. Please make sure you follow the continuation prompts. 
