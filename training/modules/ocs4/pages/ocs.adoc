...
== MCG: Create a deployment that uses Object Bucket Claims
...
MCG Object Bucket Claim *OBCs*, are used to dynamically create S3 compatible buckets that can be used by 
...
Now that the photo-album application has been deployed you can view the *Object Bucket Claim* it created. You can also view the new bucket, *Configmap* and *Secret* using the oc command.
...
Select 1 or more photos, then make sure to click the upload button.
