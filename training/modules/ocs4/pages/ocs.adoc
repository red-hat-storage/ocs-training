...
[source]
----
curl -sLO https://github.com/noobaa/noobaa-operator/releases/download/v5.7.0/noobaa-mac-v5.7.0 ; chmod +x noobaa-mac-v5.7.0 ; sudo mv noobaa-mac-v5.7.0 /usr/local/bin/noobaa
----

.Linux steps
[source]
----
curl -sLO https://github.com/noobaa/noobaa-operator/releases/download/v5.7.0/noobaa-linux-v5.7.0 ; chmod +x noobaa-linux-v5.7.0 ; sudo mv noobaa-linux-v5.7.0 /usr/bin/noobaa
----
