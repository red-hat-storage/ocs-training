...
The MCG console is not fully integrated Openshift Web Console and resources created in the MCG console
...
The photo-album application has created an object bucket claim. The new bucket, Configmap and Secret can be viewed using the oc cli.
...
oc get ob
NAME                   STORAGE-CLASS                 CLAIM-NAMESPACE   CLAIM-NAME    RECLAI
M-POLICY   PHASE   AGE
obc-demo-photo-album   openshift-storage.noobaa.io   demo              photo-album   Delete
           Bound   155m
...
photo-album   photo-album.apps.cluster-7c31.7c31.sandbox905.opentlc.com          photo-albu
m   80-tcp                 None
----
