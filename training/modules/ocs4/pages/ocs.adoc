...
* Configure and deploy containerized Ceph and MCG (Noobaa)
* Validate deployment of containerized Ceph and MCG (Noobaa)
* Deploy the Rook toolbox to run Ceph and RADOS commands
* Create a Read-Write-Once (RWO) application using Ceph RBD PVC
* Creating a Read-Write-Many (RWX) application using CephFS PVC
