...
NOTE: It is possible to auto-unseal Vault during cluster reboots and upgrades. To learn how, check out the tutorials here: https://learn.hashicorp.com/collections/vault/auto-unseal +
This does not remove the need to manually unseal Vault once after the initialization.
