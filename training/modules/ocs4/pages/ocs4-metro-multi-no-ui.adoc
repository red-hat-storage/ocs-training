...
NOTE: These steps are considered Dev Preview in ODF 4.7, and are provided for POCs purposes.
...
=======
Specific storage classes are created or existing storage classes are modified to use the specific `cephx` username craeted for each cluster and each storage class requires the `retainPolicy` to be set to `Retain`. The specifc storage classes must have the same name in each OCP cluster.
>>>>>>> 54a9d163fe31fa95bc89429cf9889b6766f3c243
...
IMPORTANT: Once the testing is complete you can clean up the left over *PersistentVolumes* as
=======
IMPORTANT: Once the testong is complete you can clean up the left over *PersistentVolumes* as
>>>>>>> 54a9d163fe31fa95bc89429cf9889b6766f3c243
a result of the *ReclaimPolicy* specific to the new storage classes.
...
NOTE: When needed you cam easily import the old `cephx` definition that you exported to
>>>>>>> 54a9d163fe31fa95bc89429cf9889b6766f3c243
...
<<<<<<< HEAD
CAUTION: When failing back it is imperative that the applicatiobn be stopped in cluster OCP-DR and that no
...
=======
# ceph auth get client.rbd.ocpa.data
>>>>>>> 54a9d163fe31fa95bc89429cf9889b6766f3c243
[client.rbd.ocpa]
	key = AQBthmNgeGFMGBAAXELMMDLzqUJqBhPp0xSfmQ==
	caps mgr = "allow rw"
